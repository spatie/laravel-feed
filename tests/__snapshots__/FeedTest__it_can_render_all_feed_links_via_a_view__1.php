<?php return '<link rel="alternate" type="application/atom+xml" href="http://localhost/feedBaseUrl/feed1" title="Feed 1">
    ...
    <link rel="alternate" type="application/feed+json" href="http://localhost/feedBaseUrl/feed1.json" title="Feed 1 using JSON">
';
